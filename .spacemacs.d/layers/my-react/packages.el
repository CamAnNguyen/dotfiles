...
(defun my-react/init-rjsx-mode ()
  (use-package rjsx-mode
    ...
    (progn
      ...
      ;; key bindings
      ;; (evil-define-key 'insert rjsx-mode-map (kbd ">") 'spacemacs//rjsx-delete-creates-full-tag-with-insert)
      ;; (evil-define-key 'normal rjsx-mode-map (kbd ">") 'spacemacs//rjsx-delete-creates-full-tag-with-insert)
      (evil-define-key 'insert rjsx-mode-map (kbd ">") nil)
      (evil-define-key 'normal rjsx-mode-map (kbd ">") nil)
...
(defun my-react/post-init-tern ()
  (add-hook 'rjsx-mode-hook 'tern-mode)
  (spacemacs|hide-lighter tern-mode)
  (spacemacs//set-tern-key-bindings 'rjsx-mode))

(defun my-react/post-init-web-beautify ()
